...
export class Barnard59NodeExplorer
  implements
    vscode.TreeDataProvider<Node>,
    vscode.TreeDragAndDropController<Node>
{
  dropMimeTypes = ["application/vnd.code.tree.barnard59Explorer"];
  ...
  constructor(context: vscode.ExtensionContext) {
    const view = vscode.window.createTreeView("barnard59Explorer", {
  ...
  public async handleDrop(
    ...
    const transferItem = sources.get(
      "application/vnd.code.tree.barnard59Explorer"
    );
    if (!transferItem) {
      return;
    }
